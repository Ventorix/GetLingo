      ...
      >
        {current ? (
          <div className='relative h-[102px] w-[102px]'>
            <div className='absolute -top-6 left-2.5 z-10 animate-bounce rounded-xl border-2 bg-white px-3 py-2.5 font-bold uppercase tracking-wide text-green-500 transition'>
              Start
